          ...
          <div className="row g-0 align-items-center justify-content-center d-flex">
            ...
            <div className="col-md-8 ">
              <div className="card-body d-flex flex-column justify-content-center align-items-center">
                ...
                <p className="card-text">
               💻 I enjoy building interactive user interfaces, developing efficient backend systems, and creating seamless digital experiences.

My journey in web development is driven by curiosity and continuous learning. I love working on real-world projects, improving my problem-solving skills, and exploring new technologies that help me grow as a developer. My goal is to build impactful applications that are both user-friendly and performance-oriented.
